...
(function() {
	CKEDITOR.plugins.add( 'image', {
		...
		init: function( editor ) {
			...
			var allowed = 'img[class,alt,!src]{border-style,border-width,float,height,margin,margin-bottom,margin-left,margin-right,margin-top,width}',
				required = 'img[alt,src]';

			if ( CKEDITOR.dialog.isTabEnabled( editor, pluginName, 'advanced' ) )
				allowed = 'img[class,alt,dir,id,lang,longdesc,!src,title]{*}(*)';
