...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Post'
        db.create_table(u'papermill_post', (
            ...
            ('meta_keywords', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('meta_description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
        ))
        db.send_create_signal(u'papermill', ['Post'])

        # Adding model 'PostCategory'
        db.create_table(u'papermill_postcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'papermill', ['PostCategory'])

        # Adding model 'PostImage'
        db.create_table(u'papermill_postimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'papermill', ['PostImage'])


    def backwards(self, orm):
        # Deleting model 'Post'
        db.delete_table(u'papermill_post')

        # Deleting model 'PostCategory'
        db.delete_table(u'papermill_postcategory')

        # Deleting model 'PostImage'
        db.delete_table(u'papermill_postimage')
    ...
    models = {
        ...
        u'papermill.post': {
            ...
            'meta_keywords': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
